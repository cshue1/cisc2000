...
int main()
{
	...
	monthSales = new float[];  // Fill in the code to allocate memory for the array pointed to by
	// monthSales.

	if ( monthSales == nullptr)   // Fill in the condition to determine if memory has been
