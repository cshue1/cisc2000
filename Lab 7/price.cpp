...
int main()
{
	...
	cout << "The highest price is: " << findHighestPrice(priceTable, rowsUsed, colsUsed) << endl << endl;
	cout << "The lowest price is: " << findLowestPrice(priceTable, rowsUsed, colsUsed) << endl << endl;
	cout << endl << endl << endl;
...
void getPrices(PriceType table, int& numOfRows, int& numOfCols)
{
	...
	for (int row = 0; row < numOfRows; row++)
	{
		for (int col = 0; col < numOfCols; col++)
		{
			...
			cin >> table[row][col];// Fill in the code to read and store the next value in the array
		}
	}
}
...
void printPrices(PriceType table, int numOfRows, int numOfCols)
{
	...
	for (int row = 0; row < numOfRows; row++)
	{
		for (int col = 0; col < numOfCols; col++)
		{
			cout << setw(7) << table[row][col];// Fill in the code to print the table
		}
		cout << endl;
	}
	cout << endl << endl << endl;
...
float findHighestPrice(PriceType table, int& numOfRows, int& numOfCols) // This function returns the highest price in the array {
{
    float highestPrice;
...
float findLowestPrice(PriceType table, int& numOfRows, int& numOfCols) // This function returns the highest price in the array {
{
    float lowestPrice;
