...
int main()
{
	...
	while (moreInput == 'y' || moreInput == 'Y')
	{
		...
		cout << "the student's average is: " << average;// Fill in code to get and print average of student to screen

		cout << " which gives the letter grade of " << findLetterGrade (average);// Fill in call to get and print letter grade of student to screen
