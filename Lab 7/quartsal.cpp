...
void getSales(SalesType	table, int&	numOfYears)
{
	...
	for (int row = 0; row < numOfYears; row++) // Fill in the code to read and store the next value
	{
	    for (int col = 0; col < 5; col++)
        {
            ...
            {
                cout << "Input the sales figures for the first quarter in " << table[row][0] << ": ";
            }
            else if (col == 2)
            {
                cout << "Input the sales figures for the second quarter in " << table[row][0] << ": ";
            }
            else if (col == 3)
            {
                cout << "Input the sales figures for the third quarter in " << table[row][0] << ": ";
            }
            else
            {
                cout << "Input the sales figures for the fourth quarter in " << table[row][0] << ": ";
            }
            cin >> table[row][col];
        }
        cout << endl << endl;
...
void printSales(SalesType table, int numOfYears)
{
	...
	{
	    for (int col = 0; col < 5; col++)
            cout << setw(10) << table[row][col] << setw(5);// Fill in the code to print the table
	    cout << endl;
	}
